  ...
  return (
    <React.Fragment>
      <Route
        ...
        path="/all/items"
        render={props => {
          if (isAuthenticated()) return <HomePage {...props} />;
      ...
      <Route
        ...
        path="/itemcategories"
        render={props => {
          if (isAuthenticated()) return <ItemCategories {...props} categories={categories} />;
          else return <Redirect to="/login" />;
        }}
      />
      ...
      <Route
        ...
        path="/myItems"
        render={props => {
          if (isAuthenticated()) return <MyItems {...props} />;
          else return <Redirect to="/login" />;
        }}
      />
      ...
      <Route
        ...
        path="/profile/update"
        render={props => {
          if (isAuthenticated()) return <MyProfileEditForm {...props} />;
          else return <Redirect to="/login" />;
        }}
      />
      ...
      <Route
        ...
        path="/profile"
        render={props => {
          if (isAuthenticated()) return <MyProfile />;
          else return <Redirect to="/login" />;
        }}
      />
      <Route
      ...
      <Route
        exact
        path="/donationboxhistory"
        render={props => {
          return (
            <DonationBoxHistory
              getItems={getItems}
              {...props}
              completeDonationboxes={completeDonationboxes}
            />
          );
        }}
      />
      ...
      <Route
        exact
        path="/donationboxhistory/:donationboxId(\d+)"
        render={props => {
          let donationbox = completeDonationboxes.find(
            donationbox => donationbox.id === +props.match.params.donationboxId
          );
          if (donationbox) {
            return (
              <DonationboxDetail
      ...
      <Route
        exact
        path="/itemcategories/:categoryId(\d+)"
        render={props => {
      ...
      <Route
        exact
        path="/cart/addDropoff"
        render={props => {
          if (isAuthenticated())
            return (
              <CompleteDonationbox
                {...props}
                getCompleteDonationboxes={getCompleteDonationboxes}
                getItems={getItems}
              />
            );
          else return <Redirect to="/login" />;
      ...
      <Route
        exact
        path="/dropoff/options"
        render={props => {
          if (isAuthenticated()) {
            return <DropoffDates {...props} />;
          } else {
            return <Redirect to="/login" />;
          }
        }}
      ...
      <Route
        ...
        path="/dropoff/create"
        render={props => {
          if (isAuthenticated()) return <DropoffDateForm {...props} />;
          else return <Redirect to="/login" />;
        }}
      />
      <Route
